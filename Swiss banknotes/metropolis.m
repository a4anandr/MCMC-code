function output = metropolis(model, options)
% metropolis: function for running Metropolis-Hastings for a given model.
...
proposalWitdthCorrection = options.proposalWidthCorrection;
